...
# Copy the built jar from the builder stage. Adjust path to where Maven places the jar in the edfwriter project.
# Use a wildcard to pick the artifact from the target directory.
COPY --from=builder /build/target/*edfwriter*.jar /processor/mefstreamer.jar
